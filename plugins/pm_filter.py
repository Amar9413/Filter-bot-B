            ...
            [
                [
                    InlineKeyboardButton(
                        "sᴜᴘᴘᴏʀᴛ 😊", url='https://t.me/+NoCC2Go46jFkN2I1'
                    )
                ]
            ]
        ),
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        [
            InlineKeyboardButton('🎁 ɢᴇᴛ ᴘʀᴇᴍɪᴜᴍ ꜰʀᴇᴇ 🎁', callback_data=f'free_premium#{query.from_user.id}'),
	    InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇᴅ ᴄʜᴀɴɴᴇʟ😊", url='https://t.me/+5kjfpYLVM25hZGNl')
        ],
        [
            InlineKeyboardButton('🎭 ʏᴏᴜʀ ᴘᴏɪɴᴛ ✨', callback_data=f'point#{query.from_user.id}'),
